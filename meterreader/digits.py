...
class DigitsCleaner(VisibleStage):
  ...
  def _process(self):
    ...
    if self._showYourWork:
      ...
      self.debugHeight = 20 + self.debugOutputLines * (self.debugDigitHeight + 20)
    ...
    if self._showYourWork:
      cv2.imshow('DigitsCleaner', cv2.resize(self.debugImage, (self.debugWidth*3, self.debugHeight*3)))
  ...
  def _initWindows(self):
    ...
    cv2.createTrackbar('blur', 'DigitsCleaner', self._params['blur'], 5, self.guicb)
    cv2.createTrackbar('thrs1', 'DigitsCleaner', self._params['thrs1'], 255, self.guicb)
    cv2.createTrackbar('thrs2', 'DigitsCleaner', self._params['thrs2'], 255, self.guicb)
